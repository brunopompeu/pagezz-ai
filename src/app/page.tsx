      ...
      <div className="relative mx-auto flex min-h-screen w-full max-w-7xl flex-col px-5 py-5 sm:px-8 lg:px-10">
        ...
        <header className="flex h-16 items-center justify-between rounded-full border border-white/70 bg-white/80 px-5 shadow-[0_16px_50px_rgba(13,39,114,0.10)] backdrop-blur">
          ...
          <nav className="hidden items-center gap-0.5 md:flex">
            <span className="cursor-not-allowed rounded-full px-3 py-1.5 text-[0.68rem] font-bold uppercase tracking-[0.5px] text-[rgba(13,39,114,0.55)] transition-colors hover:bg-[rgba(13,39,114,0.06)]">Estratégia</span>
            <span className="cursor-not-allowed rounded-full px-3 py-1.5 text-[0.68rem] font-bold uppercase tracking-[0.5px] text-[rgba(13,39,114,0.55)] transition-colors hover:bg-[rgba(13,39,114,0.06)]">Página</span>
          </nav>
